\newpage
\section{Discussion}
Dựa trên các kết quả thực nghiệm từ Task 2 đến Task 5, nhóm thực hiện đưa ra các phân tích chi tiết nhằm trả lời các câu hỏi về mối liên hệ giữa Docker và lý thuyết Hệ điều hành.
...
Dựa trên kiến trúc và hành vi quan sát được, \textbf{Docker gần với một Sandbox (cơ chế cô lập) hơn là một Virtual Machine (VM) truyền thống}, nhưng thuật ngữ chính xác nhất là \textbf{OS-level Virtualization} (Ảo hóa cấp hệ điều hành).
...
\subsection{Lựa chọn Base Image phù hợp dưới góc độ OS}
Từ kết quả so sánh ở Task 5 giữa Ubuntu, Debian Slim và Alpine, nhóm đưa ra bảng phân tích sau:
